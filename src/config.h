...
// For AP mode:
const char *ssid = "Punch";  // You will connect your TCP client to this Access Point
const char *pw = "YouAndMe"; // and this is the password
IPAddress ip(192, 168, 5, 1); // toto - change it if needed
IPAddress netmask(255, 255, 255, 0);

// You must connect the phone to this AP, then:
// menu -> connect -> Internet(TCP) -> 192.168.5.1:8880  for UART0 (main Punch com, as if it was USB connection)
//                                  -> 192.168.5.1:8881  for UART1 (for debugging or other use, can be use similiar to UART0)




#define MAX_NMEA_CLIENTS 3          //per server(uart)
